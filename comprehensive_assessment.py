...
class ComprehensiveAssessmentEngine:
    ...
    def _load_question_bank(self) -> Dict[str, List[Dict]]:
        ...
        default_questions = {
            "logical_reasoning": [
                ...
                {
                    "id": "lr_004",
                    "question": "In a row of 40 students, if A is 15th from the left and B is 18th from the right, how many students are between A and B?",
                    "options": ["7", "8", "9", "10"],
                    "correct_answer": 0,
                    "explanation": "B's position from left = 40 - 18 + 1 = 23. Students between A and B = 23 - 15 - 1 = 7",
                    "difficulty": "medium",
                ...
                {
                    "id": "lr_005",
                    "question": "Which of the following conclusions logically follows from the statements: All cats are animals. Some animals are pets.",
                    "options": [
                        "All cats are pets",
                        "Some pets are cats",
                        "Some cats are pets",
            ...
            "quantitative_aptitude": [
                ...
                },
                {
                    ...
                    "options": ["3%", "4%", "5%", "6%"],
                    "correct_answer": 1,
                    "explanation": "Gain = 28.60 - 27.50 = Rs. 1.10. Gain% = (1.10/27.50) × 100 = 4%",
                    "difficulty": "easy",
                    "topic": "profit_loss",
                    "time_limit": 60
                },
                {
                    ...
                    "correct_answer": 1,
                    "explanation": "Part filled by A in 1 min = 1/20. Part filled by B in 1 min = 1/30. Part filled by (A + B) in 1 min = 1/20 + 1/30 = 1/12. Tank will be full in 12 min.",
                    "difficulty": "medium",
            ...
            "data_interpretation": [
                ...
                {
                    "id": "di_003",
                    "question": "If a pie chart shows the distribution of expenses: Rent 30%, Food 25%, Transport 20%, Others 25%. If total expenses are Rs. 10,000, how much is spent on Food and Transport combined?",
                    "options": ["Rs. 4,000", "Rs. 4,500", "Rs. 5,000", "Rs. 5,500"],
                    "correct_answer": 1,
                    "explanation": "Food + Transport = 25% + 20% = 45% of 10,000 = Rs. 4,500",
                    "difficulty": "easy",
                    "topic": "pie_chart_analysis",
                    "time_limit": 60
                },
                {
                    "id": "di_004",
                    "question": "The bar graph shows production of units (in thousands): Jan-50, Feb-60, Mar-45, Apr-70, May-55. What is the average production for these 5 months?",
                    "options": ["54,000", "55,000", "56,000", "57,000"],
                    "correct_answer": 2,
                    "explanation": "Average = (50+60+45+70+55)/5 = 280/5 = 56 thousand units",
                    "difficulty": "medium",
                    "topic": "bar_graph_analysis",
                    "time_limit": 75
                }
            ],
            "verbal_ability": [
                ...
                },
                {
                    ...
                    "correct_answer": 2,
                    "explanation": "Benevolent means well-meaning and kindly, so its opposite is malevolent (having evil intentions).",
                    "difficulty": "medium",
                    "topic": "antonyms",
                    "time_limit": 30
                },
                {
                    "id": "va_004",
                    "question": "Fill in the blank: 'The manager was _____ by the employee's presentation.'",
                    "options": ["impressed", "impress", "impressing", "impression"],
                    "correct_answer": 0,
                    "explanation": "Past participle 'impressed' is needed in passive voice construction.",
                    "difficulty": "easy",
                    "topic": "grammar",
                    "time_limit": 45
                }
            ...
            "technical_concepts": [
                ...
                },
                {
                    ...
                    "options": ["64", "512", "729", "9"],
                    "correct_answer": 1,
                    "explanation": "Exponentiation is right-associative in Python. So 2**3**2 = 2**(3**2) = 2**9 = 512",
                    "difficulty": "medium",
                ...
                {
                    "id": "tc_004",
                    "question": "In SQL, which command is used to remove all rows from a table without deleting the table structure?",
                    "options": ["DELETE", "DROP", "TRUNCATE", "REMOVE"],
                    "correct_answer": 2,
                    "explanation": "TRUNCATE removes all rows from a table but keeps the table structure. It's faster than DELETE and cannot be rolled back.",
                    "difficulty": "medium",
                    "topic": "databases",
                    "time_limit": 45
                },
                {
                    ...
                    "correct_answer": 3,
                    "explanation": "HTTP 404 status code means the requested resource could not be found on the server.",
                    "difficulty": "easy",
    ...
    def generate_test_config(self, test_type: str, difficulty_level: str = "mixed", 
                             num_questions: int = 20) -> Dict[str, Any]:
        """
        Generate test configuration for comprehensive assessment
        """
        # Map test types to assessment types
        type_mapping = {
            'balanced': 'logical_reasoning',  # Default to logical reasoning for balanced
        ...
        # Default to logical reasoning if not found
        assessment_type = type_mapping.get(test_type, 'logical_reasoning')
        ...
        if difficulty_level != "mixed" and difficulty_level != "adaptive":
